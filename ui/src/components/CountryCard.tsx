...
export default function CountryCard({ country, liveRate, fredData, fredLoading, loading, dxyLatest, latestGdpUsd, latestInflation }: Props) {
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 flex flex-col gap-4">
      ...
      {(country.fredGdpSeries || latestGdpUsd !== null || latestInflation !== null) && (
        <div className="grid grid-cols-2 gap-2">

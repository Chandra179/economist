...
## Phase 1 — Inflation (CPI)

**Source**: FRED — all monthly index levels. Compute YoY inflation on frontend.
...
| 5 | Compute YoY inflation % from CPI index levels — `(idx_M − idx_M−12) / idx_M−12 × 100` | `ui/src/App.tsx` |

...
**The chain:**
1. Country borrows in dollars
2. Something goes bad (recession, commodity crash, war, corruption)
3. Investors panic → bond prices crash → interest rates spike
4. Country can't borrow more to roll over debt
5. Country can't print dollars (only the Fed can)
6. Dollar reserves run out → **default**

...
| **Machine tooling** | The tacit skill of mold-making and production line design (see [Supply Chain](supply-chain.md)) |
...
1. Country A breaks a rule (e.g., raises tariffs illegally)
2. Country B sues at the WTO
3. WTO panel rules — binding decision
4. If A doesn't comply, B gets authorized to retaliate (raise tariffs on A)
